module.exports = (function() {
  ...
  return (u = process.argv) => {
    const r = u.includes("headless") || u.includes("--headless"),
      i = u.includes("dev") || u.includes("--dev"),
      t = u.includes("multi-user") || u.includes("--multi-user"),
      l = s("user", u),
      o = s("username", u),
      c = s("passwd", u),
      d = o && c ? { userName: o, passwd: c } : null,
      a = s("ua", u),
      p = s("proxy", u);
    return u.includes("--version") || u.includes("-v")
      ? (console.log(e.getVersion()), e.quit(), {})
      : u.includes("--help") || u.includes("-h")
      ? (console.log(n), e.quit(), {})
      : {
          headless: r,
          dev: i,
          multiUser: t,
